...
# Chapter 8
for package in man-pages iana-etc glibc zlib bzip2 'xz utils' lz4 zstd file readline m4 bc \
    ...
    perl 'xml::parser' intltool autoconf automake openssl libelf libffi python \
